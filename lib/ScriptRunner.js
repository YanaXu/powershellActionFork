...
class ScriptRunner {
    constructor(inputFile, errorActionPreference, failOnStandardErr) {
    ...
    executeFile() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let checkFile = FileUtils_1.default.pathExists(ScriptRunner.filePath);
            core.info(`checkFile: ${checkFile}`);
            FileUtils_1.default.makeExecutable(ScriptRunner.filePath);
