...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const inlineScript = core.getInput('inlineScript', { required: false });
            const inputFile = core.getInput('inputFile', { required: false });
            ...
            const scriptRunner = new ScriptRunner_1.default(inlineScript, inputFile, errorActionPreference, failOnStandardError);
...
function validateInputs(inlineScript, inputFile, errorActionPreference) {
